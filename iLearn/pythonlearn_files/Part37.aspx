                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    <span class="s3">x &gt;= 2 and (x/y) &gt; 2</span>, it evaluates the expression
                                                    from left to right. Because of the definition
                                            of
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    <span class="s5">guardian pattern</span>. Consider the following code sequence in
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    <span class="s3">y </span>was zero, which causes a runtime error. But the first
                                                    and the second examples did
                                                    <span class="s5">not </span>fail because in the first calculation
                                                    <span class="s3">y </span>was non zero and in the second one the first part of these
                                                    expressions
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    <span class="s5">guard </span>evaluation just before the evaluation that might cause
                                                    an error as follows:
                                                </p>
                                            </div>
                                            <div class="card-body">
