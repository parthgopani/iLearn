...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <span style="color: #3F70A0;">&#39;Enter file:&#39;</span>)
                                                </p>
                                                <p>
                                                    handle
    <span style="color: #656565;">= </span>open(name,
    <span style="color: #3F70A0;">&#39;r&#39;</span>) 
                                                </p>
                                                <p>
                                                    counts
    <span style="color: #656565;">= </span>dict()
                                                ...
                                                <p>
                                                    <span>for </span>line
    <span style="color: #656565;">in </span>handle: 
                                                </p>
                                                <p>
                                                    words
    ...
    <span style="color: #231F20;">word</span>
                                                ...
                                                <p>
                                                    bigcount
    <span style="color: #656565;">= </span>count 
                                                </p>
                                                <p>
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    ...
                                                    code into a file called and run it or you download
                                                        the source code from 
    <span class="s5">words.py </span>
                                                    <a href="http://www.py4e.com/code3/" class="s4" target="_blank"></a>
