...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper" style="margin-top: 8%; margin-left: 10%;">
        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 d-flex flex-column justify-content-start">
                                <div class="ml-xl-4 mt-3">
                                    ...
                                    <h5 class="font-weight-500 mb-xl-4 text-primary">Welcome to your Scoreboard at iLearn</h5>
                                    <p class="mb-2 mb-xl-0">This will be your hub to the learning progress. Here you can track your progress and evaluate your performance.!</p>
                                </div>
                            </div>
                            <div class="col-md-6 mt-3">
                                <div class="horizontal-rectangle-card">
                                    ...
                                    <div class="circular-progress" data-inner-circle-color="white" data-percentage="80" data-progress-color="#7978E9" data-bg-color="white">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                                            <div class="ml-xl-4 mt-3">
                                                ...
                                                <p class="mb-2 mb-xl-0">These languages are also considered to be the best programming languages to learn for beginners. The given salary projection of the languages helps you decide your interest in language.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="details">
                                            <ul class="meta list-inline mb-3">
                                                <li class="list-inline-item">
                                                    <a href="#">
                                                        <img src="images/dashboard/people.png" class="author" alt="">
                                                        Planet Python
                                                    </a>
                                                </li>
                                                <li class="list-inline-item">
                                                ...
                                                <li class="list-inline-item">25 October 2023</li>
                                            </ul>
                                            <h5 class="post-tile">
                                                <a href="https://www.pythonmorsels.com/lambda-expressions/">
                                                    What are Lambda Expressions?
                                                </a>
                                            </h5>
                                            <p class="excerpt mb-0">
                                                What are lambda expressions and how are they used in python? Learn here.
                                            </p>
                                            <div class="post-bottom clearfix d-flex align-items-center">
                                                ...
                                                <div class="more-button float-end">
                                                    <a href="https://www.pythonmorsels.com/lambda-expressions/"><span class="icon-options"></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 col-sm-6">
                                    ...
                                    <div class="post post-list clearfix">
                                        ...
                                        <div class="details">
                                            ...
                                            <h5 class="post-tile">
                                                <a href="https://planetpython.org/">
                                                    From concepts to MVPs. Validate your ideas in few lines of code with streamlit.
                                                </a>
                                            </h5>
                                            <p class="excerpt mb-0">
                                            ...
                                            <div class="post-bottom clearfix d-flex align-items-center">
                                                ...
                                                <div class="more-button float-end">
                                                    <a href="https://planetpython.org/"><span class="icon-options"></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post post-list clearfix">
                                        ...
                                        <div class="details">
                                            <ul class="meta list-inline mb-3">
                                                ...
                                                <li class="list-inline-item">24 October 2023</li>
                                            </ul>
                                            <h5 class="post-tile">
                                                <a href="https://realpython.com/courses/building-systems-classes-exercises/">
                                            ...
                                            <div class="post-bottom clearfix d-flex align-items-center">
                                                ...
                                                <div class="more-button float-end">
                                                    <a href="https://realpython.com/courses/building-systems-classes-exercises/"><span class="icon-options"></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
