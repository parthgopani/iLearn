...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                                ...
                                <div class="col-md-12 grid-margin stretch-card">
                                    ...
                                    Next
                                     <i class="fa-solid fa-arrow-right" style="color: #000f;"></i>
                                            ...
                                            <p style="padding-left: 51pt; text-indent: 0pt; text-align: justify;">In the next few
                                                chapters, we will learn more about the vocabulary, sentence struc- ture, paragraph
                                                structure, and story structure of Python. We will learn about the</p>
                                            ...
                                            <p style="padding-top: 5pt; padding-left: 6pt; text-indent: 0pt; text-align: justify;">
                                                ...
                                                ming language from machine language up to the high-level languages.</p>
                                            <p style="text-indent: 0pt; text-align: left;">
                                                <br />
                                            </p>
    ...
    <span class="p">Write a set of instructions once and give them a name and then reuse
        those instructions as needed throughout your program.</span>
                                            ...
                                            <p style="padding-left: 6pt; text-indent: 0pt; text-align: justify;">It sounds almost
                                                ...
                                                to produce something that is useful to its users.</p>
