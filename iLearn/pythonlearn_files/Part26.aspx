...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <span style="color: #656565;">/ </span>
                                                    <span style="color: #3FA070;">60    </span>
                                                    <span  style="color: #65B9E3;"># percentage of an hour</span>
                                                </p>
                                            </div>
                                            <div class="card-body">
    ...
    <span style="color: #656565;">= </span>
                                                    ...
                                                    <span style="color: #65B9E3;"># assign 5 to v</span>
                                                </p>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                useful information that is not in the code:
                                                </p>
    ...
    <span style="color: #656565;">= </span>
                                                    <span style="color: #3FA070;">5    </span>
                                                    <span style="color: #65B9E3;"># velocity in meters/second.</span>
                                                </p>
                                            </div>
                                            <div class="card-body">
                                                <p>
                                                ...
                                                to read, so there is a trade-off.
                                                </p>
                                            </div>
