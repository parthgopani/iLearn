...
public partial class ExamResult : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                Session["uid"] = Convert.ToInt16(Request.QueryString["User_Id"]);
    ...
    public void insert()
    {
        ...
        string qry = "update Exam_Reg set Status_PF = '" + status + "', Score = " + Right + ", Percentage = '" + TotalPercentage + "', Exam_Given_Date = '" + gd + "'  where User_Id = " + Session["uid"] + " and Exam_Id = " + Session["eid"].ToString();
        conn.modify(qry);
    }
