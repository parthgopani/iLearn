...
=======
                                ...
                                <form id="form1" runat="server" class="forms-sample">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:DropDownList ID="drpsemester" CssClass="form-control" runat="server"
                                                AutoPostBack="false" data-toggle="dropdown"></asp:DropDownList>
                                        </div>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drpsemester"
                                            ErrorMessage="Semester is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
...
=======
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="drpcourse"
                                            ErrorMessage="Course is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lblquestiontype" class="col-sm-2 col-form-label">Select Question Type:</label>
                                        <div class="col-sm-9">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="drpcourse"
                                            ErrorMessage="Question Type is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lblQuestion" class="col-sm-2 col-form-label">Question Text:</label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtquestiontext" runat="server" CssClass="form-control"
                                                placeholder="Enter Question Text"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtquestiontext"
                                            ErrorMessage="Question Text is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lbloption1" class="col-sm-2 col-form-label">Option 1:</label>
                                        <div class="col-sm-9">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtoption1"
                                            ErrorMessage="Option 1 is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lbloption2" class="col-sm-2 col-form-label">Option 2:</label>
                                        <div class="col-sm-9">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtoption2"
                                            ErrorMessage="Option 2 is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lbloption3" class="col-sm-2 col-form-label">Option 3:</label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtoption3" runat="server" CssClass="form-control"
                                                placeholder="Enter Option 3"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtoption3"
                                            ErrorMessage="Option 3 is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lbloption4" class="col-sm-2 col-form-label">Option 4:</label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtoption4" runat="server" CssClass="form-control"
                                                placeholder="Enter Option 4"></asp:TextBox>
                                        </div>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtoption4"
                                            ErrorMessage="Option 4 is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lblcorrectanswer" class="col-sm-2 col-form-label">Correct Answer:</label>
                                        <div class="col-sm-9">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtcorrectanswer"
                                            ErrorMessage="Correct Answer is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lblcomplexity" class="col-sm-2 col-form-label">Complexity of Question:</label>
                                        <div class="col-sm-9">
                                            <asp:DropDownList ID="drpcomplexity" CssClass="form-control" runat="server"
                                                AutoPostBack="false" data-toggle="dropdown">
                                            </asp:DropDownList>
                                        </div>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="drpcomplexity"
                                            ErrorMessage="Complexcity is required" ForeColor="Red" ValidationGroup="fieldcheck"></asp:RequiredFieldValidator>
                                    </div>
                                    <asp:Button ID="btnadd" runat="server" Text="ADD" class="btn btn-inverse-primary mr-2" />
                                    <asp:Button ID="btnupdate" runat="server" Text="UPDATE" class="btn btn-inverse-info mr-2" />
                                    <asp:Button ID="btndelete" runat="server" Text="DELETE" class="btn btn-inverse-danger mr-2" />
                                    <asp:Button ID="btncancel" runat="server" Text="CANCEL" class="btn btn-inverse-dark mr-2" />
                                     <div class="col-md-12 grid-margin">
                                         <div class="row">
                                             <div class="col-12 col-xl-12 mb-4 mb-xl-0">
                                                 <div class="card">
                                                     <div class="card-body">
                                                         ...
                                                         <asp:GridView ID="grdquestion" runat="server" AutoGenerateColumns="false"
                                                             OnRowCommand="grdquestion_RowCommand" AllowPaging="true" PageSize="15"
                                                             OnPageIndexChanging="grdquestion_PageIndexChanging" AllowSorting="true"
                                                             OnSorting="grdquestion_Sorting" HorizontalAlign="Center" CssClass="gridview">
                                                             <Columns>
