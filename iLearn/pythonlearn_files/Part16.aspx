...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <span style="color: #3FA070;">4</span>
                                            ...
                                            <p style="padding-left: 52pt; text-indent: 0pt; text-align: justify;">If you are not
                                                sure what type a value has, the interpreter can tell you.</p>
                                            <p style="text-indent: 0pt; text-align: left;">
                                                <br />
                                            </p>
                                            <p class="s3" style="padding-left: 52pt; text-indent: 0pt; text-align: left;">
    ...
    <span class="s23">class </span>
                                            ...
                                            <p style="padding-left: 52pt; text-indent: 0pt; text-align: justify;">What about values
                                                like “17” and “3.2”? They look like numbers, but they are in quotation marks like
                                                strings.</p>
                                            <p style="text-indent: 0pt; text-align: left;">
                                                <br />
                                            </p>
                                            <p style="padding-left: 151pt; text-indent: 0pt; text-align: center;">19</p>
                                            <p style="text-indent: 0pt; text-align: left;">
                                                <br />
                                            </p>
                                            <p class="s3" style="padding-top: 3pt; padding-left: 7pt; text-indent: 0pt; text-align: left;">
    ...
    <span class="s23">class </span>
                                            ...
                                            <p style="padding-left: 6pt; text-indent: 0pt; text-align: left;">They’re strings.
                                            </p>
    ...
    <span style="color: #3FA070;">000</span>)
                                            ...
                                            <p class="s15" style="padding-left: 7pt; text-indent: 0pt; text-align: left;">1 0 0
                                            </p>
                                            <p style="text-indent: 0pt; text-align: left;">
                                                <br />
                                            </p>
                                            <p style="padding-left: 7pt; text-indent: 0pt; text-align: justify;">Well, that’s not
                                                what we expected at all! Python interprets 1,000,000 as a comma- separated sequence
                                                of integers, which it prints with spaces between.</p>
                                            <p style="padding-top: 5pt; padding-left: 7pt; text-indent: 0pt; text-align: justify;">
                                                This is the first example we have seen of a semantic error: the code runs without
                                                producing an error message, but it doesn’t do the “right” thing.</p>
                                            <a href="part15.aspx">
                                                <button type="button" class="btn btn-outline-primary btn-icon-text">
                                                    <i class="ti-file btn-icon-prepend"></i>
                                                    Previous
