...
public partial class Program : System.Web.UI.Page
{
    ...
    {
        gf.fillcombo("select * from Registeration r, Login l where r.Email = l.Email and l.Type='PCordinator'", prgconame, "f_name","reg_id","");
    }
    private void bindgrid()
    {
        DataSet ds = new DataSet();
        ds = conn.select("select * from Program p , Registeration r where p.Pro_Cor_Id=r.Reg_Id order by p.Program_Id desc");
