...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <span style="color: #231F20;">input()</span>
                                                </p>
                                                <p>

                                                    <span style="color: #231F20;">Some silly stuff</span>
                                                </p>
                                                <p>
                                                    &gt;&gt;&gt;
    <span style="color: #231F20;">print(inp)</span>
    ...
    <span style="color: #656565;">is </span>your name?
                                                ...
                                                <p>
                                                    &gt;&gt;&gt;
    <span style="color: #231F20;">print(name) </span>
                                                </p>
                                                <p>
                                                    <span style="color: #231F20;">Chuck</span>
                                                </p>
                                            </div>
                                            <div class="card-body">
                                                <p>
    ...
    <span style="color: #3FA070;">5 </span>
                                                ...
                                                <p>
                                                    <span style="color: #3FA070;">22</span>
                                                </p>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    But if the user
                                                types something other than a string of digits, you get an error:
                                                </p>
                                                <p>
                                                    <br />
                                                </p>
    ...
    <span style="color: #3FA070;">10</span>:
                                            ...
                                            <div class="card-body">
                                                <p>
                                                    We will see how
                                                to handle this kind of error later.
                                                </p>
                                            </div>
                                            <a href="part24.aspx">
                                                <button type="button" class="btn btn-outline-secondary btn-icon-text">
