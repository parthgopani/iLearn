...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <span class="s5">rules of precedence</span>. For mathematical operators, Python follows mathematical convention. The acronym
                                            ...
                                            <div class="card-body">
                                                <ul>
                                                    <li>
                                                        <span class="s5"><em>P </em></span>arentheses have the highest precedence and can
                                                        be used to force an expres- sion to evaluate in the order you want. Since expressions in parentheses are evaluated first,
                                                        <span class="s3">2 * (3-1) </span>is 4, and
                                                        <span class="s3">(1+1)**(5-2) </span>is 8. You can also use parentheses to make
                                                        an expression easier to read, as in
                                                        <span class="s3">(minute * 100) / 60</span>, even if it doesn’t change the result.
                                                    </li>
                                                    <li>
                                                        <span class="s5"><em>M</em> </span>ultiplication and
                                                        <span class="s5"><em>D</em></span>ivision have the same precedence, which is higher
                                                        than
                                                        <span class="s5"><em>A</em></span>ddition and
                                                        <span class="s5"><em>S</em></span>ubtraction, which also have the same precedence.
                                                        So
                                                        <span class="s3">2*3-1 </span>is 5, not 4, and
                                                        <span class="s3">6+4/2 </span>is 8, not 5.
                                                    </li>
                                                    <li>Operators with the same precedence are evaluated from left to right. So the expression
                                                        <span class="s3">5-3-1 </span>is 1, not 3, because the
                                                        <span class="s3">5-3 </span>happens first and then
                                                        <span class="s3">1 </span>is subtracted from 2.
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="card-body">
